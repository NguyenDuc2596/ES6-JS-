...
// --> khai báo bằng var có thể cập nhật nhưng không thể khai báo lại
...
// ---> Không thể cập nhập, không thể khai báo lại
...
//     anSang:'xoi' 
// } 
// console.log(buaAn); //ReferenceError: anToi is not defined
...
//--->Không được phép chỉnh sưa buaAn, nhưng có thể chỉnh sử dữ liệu bên trong cái buaAn(vd:anTrua,anToi),áp dụng cho cả
//  OJ và ARR, FUNCTION
